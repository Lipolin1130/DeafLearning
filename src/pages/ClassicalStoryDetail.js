...
import mouth1 from "../assets/mouth1.mp4";
import mouth4 from "../assets/mouth4.mp4";
import mouth8 from "../assets/mouth8.mp4";
...
function ClassicalStoryDetail() {
  ...
  useEffect(() => {
    if (currentIndex < currentStory.frames.length - 1) {
  ...
  }, [currentIndex, currentStory.frames]);

  if (currentStory.frames.length === 0) {
    return <div>no dataaaaaaaaaaa</div>;
  }
